...
NOTICE: you MUST Use strictly the following format:

Question: the input question you must answer
Thought: you should always think about what to do
Action: the action to take, should be one of [{tool_names}]
Action Input: the input to the action, it is a JSON object containing the input arguments. 
  - It must always include the original question under the key "question".
  - Example: {{"question": "请假如何请"}}
